...
export default function LoginSignup() {
    ...
    return (
        <div className="relative m-auto h-screen flex items-center justify-center text-gray-500 ">
            <div className="m-auto md:w-[480px] ">
                <div className="rounded-xl bg-white ">
                    <div className="p-10 md:p-16">
                        ...
                        <form onSubmit={handleFormSubmit} className="space-y-4">
                            ...
                            <button
                                type="submit"
                                className="w-full h-12 bg-red-500 text-white rounded-md font-semibold hover:bg-red-600 text-center"
                            >
                                {authSpinner ? <Spinner className='animate-spin block m-auto' size={24}></Spinner> : isSignup ? "Sign Up" : "Log In"}
                            </button>
                        </form>

                        {message && <p className=" my-4 text-center flex items-center justify-center gap-2 text-sm text-nowrap">{message}
